...
public class RegisterCodeTimerService extends Service {
    public static final String IN_RUNNING = "activitytest.example.com.title.Activity.IN_RUNNING";
    public static final String END_RUNNING = "activitytest.example.com.title.Activity.END_RUNNING";
